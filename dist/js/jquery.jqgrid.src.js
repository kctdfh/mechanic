	...
	$.extend(true, jgrid, {
		...
		icons: {
			...
			feather: {
				...
				pager: {
					common: "",
					first: "feather-rewind",
					prev: "feather-chevron-left",
					next: "feather-chevron-right",
					last: "feather-fast-forward"
				},
				sort: {
					common: "",        // common: "",
					asc: "feather-arrow-up",     // asc: "fa-sort-amount-asc",
					desc: "feather-arrow-down"    // desc: "fa-sort-amount-desc"
				},
				gridMinimize: {
					visible: "feather-chevron-up",
					hidden: "feather-chevron-down"
				},
				nav: {
					common: "",
					edit: "feather-edit-3",
					...
					refresh: "feather-refresh-ccw",
					view: "feather-file",
					save: "feather-save",
					cancel: "feather-slash",
					newbutton: "feather-external-link"
				},
				actions: {
					common: "",
					edit: "feather-edit-3",
					del: "feather-delete",
					save: "feather-save",
					cancel: "feather-x-circle"
				},
				form: {
					close: "feather-x",
					prev: "feather-arrow-left-circle",
					next: "feather-arrow-right-circle",
					save: "feather-save",
					undo: "feather-corner-up-left",
					del: "feather-delete",
					cancel: "feather-x-circle",
					resizableLtr: "feather-arrow-down-right"
				},
				search: {
					search: "feather-search",
					reset: "feather-delete",
					query: "feather-message-circle"
				},
				subgrid: {
					common: "",
					plus: "feather-plus",
				...
				grouping: {
					common: "",
					plus: "feather-plus-square",
					minus: "feather-minus-square"
				},
				treeGrid: {
					common: "",
					minus: "feather-chevron-down",
					leaf: "feather-circle",
					plusLtr: "feather-chevron-right",
					plusRtl: "feather-chevron-left"
				},
				checkbox: {
					checkedClasses: "feather-check",
					checked: "feather-check",
					unchecked: "feather-x"
				}
			},
			fontAwesome5: {
		...
		guiStyles: {
			...
			large: {
				...
				grid: "",
				/* row text size and border color */
				gridRow: "row-theme",
				/* row height through vertical padding */
				rowNum: "large-row-num",
				gridFooter: "",
				rowFooter: "ui-widget-content",
				gridTitle: "ui-widget-header ui-corner-top",
				gridError: "ui-state-error",
				...
				toolbarUpper: "ui-state-default",
				toolbarBottom: "ui-state-default",
				/* row height through action icon size */
				actionsDiv: "text-md",
				actionsButton: "hover:text-blue-500 px-1",
				pager: {
					/* pager padding matches header padding */
					pager: "largePager large-pager-wrapper",
					pagerButton: "large-pager-btn",
					pagerInput: "ui-widget-content",
					pagerSelect: "ui-widget-content"
				},
				navButton: "large-nav-btn",
				searchDialog: {
					operator: "ui-corner-all",
					label: "ui-corner-all",
					elem: "ui-corner-all",
				...
				searchToolbar: {
					...
					clearButton: "large-filter-operators"
				},
				top: "",
				bottom: "",
